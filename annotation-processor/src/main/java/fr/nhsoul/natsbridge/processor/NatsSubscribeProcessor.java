        ...
        try {
            ...
            try (Writer writer = file.openWriter()) {
                ...
                for (int i = 0; i < subscriptions.size(); i++) {
                    ...
                    json.append("  {\n");
                    json.append("    \"className\": \"").append(escapeJson(sub.className)).append("\",\n");
                    json.append("    \"methodName\": \"").append(escapeJson(sub.methodName)).append("\",\n");
                    json.append("    \"paramType\": \"").append(escapeJson(sub.paramType)).append("\",\n");
                    json.append("    \"subject\": \"").append(escapeJson(sub.subject)).append("\",\n");
                    json.append("    \"async\": ").append(sub.async).append("\n");
                    json.append("  }");
